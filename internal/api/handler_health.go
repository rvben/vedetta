		...
		"checks": map[string]any{
			...
			"storage": map[string]any{
				...
				"recompression": map[string]any{
					...
					"transcode_failures":    storageStats.Recompression.TranscodeFailures,
					"worker_crashes":        storageStats.Recompression.WorkerCrashes,
					"worker_timeouts":       storageStats.Recompression.WorkerTimeouts,
